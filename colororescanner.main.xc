...
;Computer IO 0: Screen
;Computer IO 1: Ore scanner
;Computer IO 2: Pivot (make sure to turn off servo mode with V)
;COMPUTER IO 3: speed sensor
;COMPUTER IO 4: angular velocity sensor
;COMPUTER IO 8: (can be any:terrain_scanner"
;COMPUTER io 9: BATTERY
...
const $vlongRange = 10000
const $vvlongRange = 20000
...
const $ButtonHeight = 20 ; reduce this if the menus don't fit on screen. Bigger buttons are easier to hit.
...
function @drawRangeButtons()
	...
	@drawRangeButton(4,$vlongrange)
	@drawRangeButton(5,$vvlongrange)
